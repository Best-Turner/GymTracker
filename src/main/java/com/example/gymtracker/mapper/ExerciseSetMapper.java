...
public interface ExerciseSetMapper extends EntityMapper<RequestExerciseSetDto, ExerciseSet, ExerciseSetShortResponse> {
    ...
    void updateExerciseSet(RequestExerciseSetDto requestExerciseSetDto, ExerciseSet exerciseSet);

    void patchExerciseSet(RequestExercisePatchDto requestExercisePatch, ExerciseSet exerciseSet);
}
